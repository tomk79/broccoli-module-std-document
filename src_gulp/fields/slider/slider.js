window.broccoliModuleStdDocumentSlider = function(broccoli){
	var $ = require('jquery');
	...
	this.mkEditor = function( mod, data, elm, callback ){
		...
		$rtn.append(
			'<table class="broccoli-module-std-document-slider__table">'+
				'<tr>'+
					'<td class="broccoli-module-std-document-slider__margin">margin</td>'+
					'<td class="broccoli-module-std-document-slider__margin"></td>'+
					'<td class="broccoli-module-std-document-slider__margin"><input type="text" class="form-control" name="'+mod.name+'__margin-top" value="" style="width: 5em;" /></td>'+
					'<td class="broccoli-module-std-document-slider__margin"></td>'+
					'<td class="broccoli-module-std-document-slider__margin"></td>'+
				'</tr>'+
				'<tr>'+
					'<td class="broccoli-module-std-document-slider__margin"></td>'+
					'<td class="broccoli-module-std-document-slider__padding" style="border-top-width: 1px; border-left-width: 1px;">padding</td>'+
					'<td class="broccoli-module-std-document-slider__padding" style="border-top-width: 1px;"><input type="text" class="form-control" name="'+mod.name+'__padding-top" value="" style="width: 5em;" /></td>'+
					'<td class="broccoli-module-std-document-slider__padding" style="border-top-width: 1px; border-right-width: 1px;"></td>'+
					'<td class="broccoli-module-std-document-slider__margin"></td>'+
				'</tr>'+
				'<tr>'+
					'<td class="broccoli-module-std-document-slider__margin"><input type="text" class="form-control" name="'+mod.name+'__margin-left" value="" style="width: 5em;" /></td>'+
					'<td class="broccoli-module-std-document-slider__padding" style="border-left-width: 1px;"><input type="text" class="form-control" name="'+mod.name+'__padding-left" value="" style="width: 5em;" /></td>'+
					'<td></td>'+
					'<td class="broccoli-module-std-document-slider__padding" style="border-right-width: 1px;"><input type="text" class="form-control" name="'+mod.name+'__padding-right" value="" style="width: 5em;" /></td>'+
					'<td class="broccoli-module-std-document-slider__margin"><input type="text" class="form-control" name="'+mod.name+'__margin-right" value="" style="width: 5em;" /></td>'+
				'</tr>'+
				'<tr>'+
					'<td class="broccoli-module-std-document-slider__margin"></td>'+
					'<td class="broccoli-module-std-document-slider__padding" style="border-bottom-width: 1px; border-left-width: 1px;"></td>'+
					'<td class="broccoli-module-std-document-slider__padding" style="border-bottom-width: 1px;"><input type="text" class="form-control" name="'+mod.name+'__padding-bottom" value="" style="width: 5em;" /></td>'+
					'<td class="broccoli-module-std-document-slider__padding" style="border-bottom-width: 1px; border-right-width: 1px;"></td>'+
					'<td class="broccoli-module-std-document-slider__margin"></td>'+
				'</tr>'+
				'<tr>'+
					'<td class="broccoli-module-std-document-slider__margin"></td>'+
					'<td class="broccoli-module-std-document-slider__margin"></td>'+
					'<td class="broccoli-module-std-document-slider__margin"><input type="text" class="form-control" name="'+mod.name+'__margin-bottom" value="" style="width: 5em;" /></td>'+
					'<td class="broccoli-module-std-document-slider__margin"></td>'+
					'<td class="broccoli-module-std-document-slider__margin"></td>'+
				'</tr>'+
			'</table>'

window.addEventListener('load', function(e){
	...
	for(var idx = 0; idx < accordionModules.length; idx ++){
		// console.log(idx);
		var units = accordionModules[idx].querySelectorAll('.px2-accordion__unit');
		...
		for(var idxUnit = 0; idxUnit < units.length; idxUnit ++){
			var a = units[idxUnit].querySelector('.px2-accordion__label a');
			var content = units[idxUnit].querySelector('.px2-accordion__content');
